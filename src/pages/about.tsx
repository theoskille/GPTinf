  ...
  return (
    ...
    <div className={styles.container}>
      ...
      <p className={styles.p}>
        ...
        <br/><br/>I firmly believe that we should not put limitations on the use of this tool. AI has the ability to solve some of the world's most pressing challenges and help us create a better future. By preventing the vilification of AI, we can unlock its full potential and empower people from all backgrounds to create innovative solutions and make a positive impact in their communities.
      </p>
